            ...
            for j in range(len(parsed_json["data"]["Page"]["mediaList"])):   # it needs to add one anime at 1 loop go
                ...
                if record:
                    ...
                    if db_timestamp != updatedAt_timestamp:
                        ...
                        chapters_parsed, volumes_parsed , progress_parsed,volumes_progress_parsed ,score_parsed , repeat_parsed, large_parsed, isFavourite_parsed, siteUrl_parsed, mal_url_parsed, updatedAt_parsed_for_db,
                    ...
                    #     isFavourite_parsed, siteUrl_parsed, mal_url_parsed, updatedAt_parsed_for_db, created_at_for_db, 
                    #     cleanded_user_startedAt, cleanded_user_completedAt, cleaned_notes, cleaned_description, 
                    #     country_parsed, media_startDate_parsed, media_endDate_parsed, genres, media_externalLinks_parsed
                    # )             
                    #--------------------------------
                    insert_query = """
                    INSERT INTO `manga_list2` (
